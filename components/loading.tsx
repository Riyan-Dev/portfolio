    ...
    <div className="fixed inset-0 bg-black z-50 flex flex-col items-center justify-center">
      <div className="w-64 relative">
        ...
        <div className="h-2 w-full bg-gray-800 rounded-full overflow-hidden relative">
          {/* Gradient background */}
          <motion.div
            className="absolute inset-0 bg-gradient-to-r from-purple-600 via-cyan-500 to-purple-600"
            initial={{ x: "-100%" }}
            animate={{ x: "0%" }}
            transition={{
          ...
          {/* Glow effect */}
          <motion.div
            className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-cyan-500/20 blur-sm"
            initial={{ width: 0 }}
            animate={controls}
            transition={{ duration: 0.1 }} // Added a small duration for smoother animation
          />
