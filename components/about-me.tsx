...
const timelineData = [
  {
    ...
    skills: ["Computer Vision", "Redis", "WebRTC", "Python", "Real-time Systems"],
  },
  {
    id: 2,
            ...
            <div className="md:w-2/3">
              <div className="prose prose-invert max-w-none text-center md:text-left">
                ...
                <p className="text-lg leading-relaxed md:hidden">
                  AI Software Engineer 🤖 and Full Stack Dev 💻. Building intelligent solutions with Flutter, Node.js,
                  and cutting-edge AI. From computer vision to blockchain, turning complex problems into elegant code.
                  🚀⚡🔥
                </p>
                {/* Desktop description */}
                <div className="hidden md:block">
                  ...
                  <p className="mb-4">
                    An <strong>AI Software Engineer 🤖</strong> and <strong>Full Stack Wizard 💻</strong>, crafting
                    intelligent solutions that bridge the gap between <strong>artificial intelligence</strong> and{" "}
                    <strong>real-world applications</strong>! Whether it's <strong>computer vision pipelines</strong>,{" "}
                    <strong>Flutter apps</strong>, or <strong>blockchain platforms</strong>, I love turning complex
                    problems into elegant code.
                  </p>
                  <p className="mb-4">
                    I spend my days building{" "}
                    <strong>
                      real-time AI systems, optimizing APIs, and creating cross-platform mobile experiences
                    </strong>
                    —and my nights exploring the latest in <strong>machine learning and Web3</strong>. 🧠 When I'm not
                    coding, I'm probably fine-tuning models, contributing to <strong>open-source projects</strong>, or
                    mentoring fellow developers.
                  </p>
                  <p>
                    With a <strong>3.94 CGPA</strong> and multiple academic honors, I believe in{" "}
                    <strong>continuous learning and innovation</strong>. Let's{" "}
                    <strong>connect, collaborate, and create the future</strong>—because the best solutions come from
                    passionate minds working together! 🌟⚡🔥
                  </p>
                </div>
              </div>
            </div>
                    ...
                    <div className="md:w-1/2 p-6 bg-gray-900/50 rounded-xl backdrop-blur-sm border border-gray-800">
                      <div className="flex flex-col md:flex-row items-center gap-4">
                        ...
                        <div className="text-center md:text-left">
                          ...
                          <h4 className="text-lg text-cyan-400">{item.company}</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {Object.entries(skillsData).map(([category, skills]) => (
                <div key={category} className="p-6 bg-gray-900/50 rounded-xl backdrop-blur-sm border border-gray-800">
                  <h4 className="text-xl font-bold mb-4 text-cyan-400 text-center md:text-left">{category}</h4>
                  {skills.map((skill) => (
